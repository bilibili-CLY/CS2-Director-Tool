...
public partial class MainViewModel : ViewModelBase
{
    ...
    public MainViewModel(Func<bool> prerequisitesMet)
    {
        ...
        SelectTabCommand = new RelayCommand<TabItem>(tab =>
        {
            ...
            // 日志/比赛信息页为诊断与只读查询页，始终可直接访问。
            if (tab.Id != HomeTabId && tab.Id != LogTabId && tab.Id != MatchTabId && !IsDevelopment && !_prerequisitesMet())
            {
    ...
    private const string MatchTabId = "matchInfo";
